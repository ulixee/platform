...
any_keyword -> %kw_all | %kw_analyse | %kw_analyze | %kw_and | %kw_any | %kw_array | %kw_as | %kw_asc | %kw_asymmetric | %kw_authorization | %kw_binary | %kw_both | %kw_case | %kw_cast | %kw_check | %kw_collate | %kw_collation | %kw_concurrently | %kw_cross | %kw_current_catalog | %kw_current_date | %kw_current_role | %kw_current_schema | %kw_current_time | %kw_current_timestamp | %kw_current_user | %kw_default | %kw_deferrable | %kw_desc | %kw_distinct | %kw_else | %kw_end | %kw_false | %kw_fetch | %kw_for | %kw_foreign | %kw_freeze | %kw_from | %kw_full | %kw_grant | %kw_group | %kw_having | %kw_ilike | %kw_in | %kw_initially | %kw_inner | %kw_into | %kw_is | %kw_isnull | %kw_join | %kw_lateral | %kw_leading | %kw_left | %kw_like | %kw_limit | %kw_localtime | %kw_localtimestamp | %kw_natural | %kw_not | %kw_notnull | %kw_null | %kw_offset | %kw_on | %kw_only | %kw_or | %kw_order | %kw_outer | %kw_overlaps | %kw_placing | %kw_primary | %kw_references | %kw_returning | %kw_right | %kw_select | %kw_session_user | %kw_similar | %kw_some | %kw_symmetric | %kw_table | %kw_tablesample | %kw_then | %kw_to | %kw_trailing | %kw_true | %kw_unique | %kw_user | %kw_using | %kw_variadic | %kw_verbose | %kw_when | %kw_where
