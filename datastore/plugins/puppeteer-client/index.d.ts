...
declare type IContextAddons = {
    launchBrowser(): Promise<PuppeteerBrowser>;
};
export declare type IPuppeteerExtractorContext<ISchema> = IExtractorContext<ISchema> & IContextAddons;
export declare type IPuppeteerExtractorRunOptions<ISchema> = IExtractorRunOptions<ISchema> & IPuppeteerLaunchOptions;
