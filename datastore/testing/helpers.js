...
async function createLocalNode(config, onlyCloseOnFinal = false, paymentInfo) {
    ...
    if (paymentInfo) {
        const paymentProcessor = new ArgonPaymentProcessor_1.default(datastoreConfig.datastoresDir, null);
