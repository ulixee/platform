...
- isPublic `boolean`. Optional parameter to make a table private. This means it can only be accessed by other [Runners](./function.md) and [Crawlers](./crawler.md) in the same [Datastore](./datastore.md).
