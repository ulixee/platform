...
declare const datastore: Datastore<{
    ...
    crawlers: {
        crawl: Crawler<false, {
            ...
            url: import("@ulixee/schema/lib/StringSchema").default<false>;
        }, import("@ulixee/datastore-plugins-hero").IExtractorSchema<{
            maxTimeInCache: import("@ulixee/schema/lib/NumberSchema").default<true>;
        } & {
            url: import("@ulixee/schema/lib/StringSchema").default<false>;
        }, {
            ...
            version: import("@ulixee/schema/lib/StringSchema").default<false>;
            sessionId: import("@ulixee/schema/lib/StringSchema").default<false>;
        }>, object, object, object>, import("@ulixee/datastore/interfaces/IExtractorPluginStatics").IExtractorPluginConstructor<import("@ulixee/datastore-plugins-hero").IExtractorSchema<{
            maxTimeInCache: import("@ulixee/schema/lib/NumberSchema").default<true>;
        } & {
            url: import("@ulixee/schema/lib/StringSchema").default<false>;
        }, {
            ...
            version: import("@ulixee/schema/lib/StringSchema").default<false>;
            sessionId: import("@ulixee/schema/lib/StringSchema").default<false>;
        }>, object, object, object>, Omit<import("@ulixee/datastore-plugins-hero").IExtractorContext<import("@ulixee/datastore-plugins-hero").IExtractorSchema<{
            maxTimeInCache: import("@ulixee/schema/lib/NumberSchema").default<true>;
        } & {
            url: import("@ulixee/schema/lib/StringSchema").default<false>;
        }, {
    ...
    extractors: {
        extract: Extractor<import("@ulixee/datastore-plugins-hero").IExtractorSchema<{
            ...
            [x: string]: any;
        }>, object, object, object>, import("@ulixee/datastore-plugins-hero").IExtractorContext<import("@ulixee/datastore-plugins-hero").IExtractorSchema<{
            [x: string]: any;
        }, {
            [x: string]: any;
        }>> & {
