...
class StatsTrackerDiskStore extends TypedEventEmitter_1.default {
    ...
    recordQuery(details) {
        ...
        this.queryLogDb.logTable.record(details.queryId, details.datastoreId, details.version, details.query, details.startTime, details.affiliateId, details.input, details.outputs, details.error, details.micronoteId, details.creditId, details.microgons, details.bytes, details.milliseconds, details.heroSessionIds, details.cloudNodeHost, details.cloudNodeIdentity);
    }
}
