...
const RemotePaymentService_1 = require("@ulixee/datastore/payments/RemotePaymentService");
...
const Escrow_register_1 = require("./endpoints/Escrow.register");
...
const EscrowSpendTrackerClient_1 = require("./lib/EscrowSpendTrackerClient");
const LocalchainWithSync_1 = require("./lib/LocalchainWithSync");
...
class DatastoreCore extends TypedEventEmitter_1.default {
    ...
    constructor(options, plugins) {
        ...
        this.options = {
            ...
            escrowSpendTrackingHost: env_1.default.escrowSpendTrackingHost,
            paymentServiceHost: env_1.default.paymentServiceHost,
    ...
    async start(options) {
        ...
        try {
            ...
            const localPaymentService = new LocalPaymentService_1.default();
            const paymentServiceConnection = createConnectionToServiceHost(this.options.paymentServiceHost);
            if (paymentServiceConnection) {
                this.remoteDatastorePaymentService = new RemotePaymentService_1.default(paymentServiceConnection);
            }
            else {
                this.remoteDatastorePaymentService = localPaymentService;
            }
            if (this.options.localchainConfig?.localchainPath) {
                this.localchain = new LocalchainWithSync_1.default(this.options.localchainConfig);
                await this.localchain.load();
                localPaymentService.localchainPaymentService = this.localchain.createPaymentService(this.datastoreApiClients);
                this.remoteDatastorePaymentService = localPaymentService;
                this.datastoreHostLookup = this.localchain.datastoreLookup;
                this.escrowSpendTracker = new EscrowSpendTracker_1.default(this.options.datastoresDir, this.localchain);
            }
            else {
                ...
                const escrowConnection = createConnectionToServiceHost(this.options.escrowSpendTrackingHost);
                if (escrowConnection) {
                    this.escrowSpendTracker = new EscrowSpendTrackerClient_1.default(escrowConnection);
                }
            }
            this.vm = new DatastoreVm_1.default(this.connectionToThisCore, this.datastoreApiClients, Object.values(this.pluginCoresByName), this.datastoreHostLookup, this.remoteDatastorePaymentService);
