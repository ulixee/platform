...
class QueryLogTable extends SqliteTable_1.default {
    ...
    record(queryId, datastoreId, version, query, startTime, affiliateId, input, outputs, error, escrowId, creditId, microgons, bytes, milliseconds, heroSessionIds, cloudNodeHost, cloudNodeIdentity) {
        microgons ??= 0;
        this.insertNow([
            queryId,
            datastoreId,
