...
exports.validateThenRun = void 0;
...
const EscrowServiceApis_1 = require("@ulixee/platform-specification/services/EscrowServiceApis");
    ...
    constructor() {
        ...
        for (const [api, handler] of Object.entries(this.handlersByCommand)) {
            const validationSchema = DatastoreRegistryApis_1.DatastoreRegistryApiSchemas[api] ??
                ...
                EscrowServiceApis_1.EscrowServiceApiSchemas[api] ??
