...
export interface IQueryInternalCallbacks {
    ...
    onFunction?<TOutput = any[], TSchema = any>(id: number, name: string, options: IExtractorRunOptions<TSchema>, run: (options: IExtractorRunOptions<TSchema>) => Promise<TOutput>): Promise<TOutput>;
