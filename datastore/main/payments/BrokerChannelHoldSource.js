...
class BrokerChannelHoldSource {
    ...
    async createChannelHold(paymentInfo, milligons) {
        ...
        const signatureMessage = BrokerChannelHoldSource.createSignatureMessage(paymentInfo.domain, paymentInfo.id, this.authentication.publicKey, milligons, nonce);
    ...
    static createSignatureMessage(domain, datastoreId, identity, milligons, nonce) {
        return (0, hashUtils_1.sha256)((0, bufferUtils_1.concatAsBuffer)('Databroker.createChannelHold', identity, nonce, domain, datastoreId, milligons.toString()));
    }
