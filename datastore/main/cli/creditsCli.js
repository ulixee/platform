...
const CreditPaymentService_1 = require("../payments/CreditPaymentService");
function creditsCli() {
    ...
    cli
        ...
        const microgons = ArgonUtils_1.default.milligonsToMicrogons(parseFloat(argons) * Number(ArgonUtils_1.default.MilligonsPerArgon));
        const identity = Identity_1.default.loadFromFile(identityPath, { keyPassphrase: identityPassphrase });
        const { datastoreId, version, host } = await DatastoreApiClient_1.default.lookupDatastoreHost(url, mainchainUrl);
    ...
    cli
        ...
        .option('-m, --mainchain-url [url]', 'The mainchain url to use.')
        .option('-d, --credit-dir [path]', 'The directory to store credits in.', CreditPaymentService_1.default.defaultBasePath)
        ...
        try {
            ...
            const service = await CreditPaymentService_1.default.storeCredit(datastoreId, version, client.connectionToCore.transport.host, {
                id,
                secret,
