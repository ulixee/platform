  ...
  <MainLayout :showPadding="false">
    <AboveTheFold>
      ...
      <p class="font-light mb-5">
        Ulixee Server is designed to easily run and scale your production scripts across one or more clouds. They run Databoxes and, when the blockchain is turned on, will participate in a consensus algorithm to close blocks.
      </p>

      <CurrentStatus version="2.0-alpha" source="ulixee/server" package="@ulixee/server">
...
export default Vue.defineComponent({
  ...
  async mounted() {
    this.roadmap = await Data.fetchRoadmap('Server');
  }
});
</script>
