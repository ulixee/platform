<template>
  <div class='pt-[53px]'>
    <div class="border-b border-slate-300 px-6 py-5 text-xl font-bold tracking-[0.2em] uppercase">
      <router-link to='/documentation' class='text-ulixee-purple opacity-50 no-underline'>Documentation</router-link>
      <span class='text-slate-400 font-light'>/</span>
      <span class='text-ulixee-purple'>{{ toolName }}</span>
    </div>
...
.LEFTBAR {
  ...
  a {
    ...
    &.isSelected {
      @apply text-ulixee-purple border-ulixee-purple border-l-4 pl-2;
    }
  }
}
