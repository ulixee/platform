<template>
  <MainLayout :showPadding="false">
    <AboveTheFold>
      ...
      <CurrentStatus version="2.0-alpha" source="ulixee/chromealive" package="@ulixee/chromealive">
...
import IRoadmap from '@/site-ulixee/interfaces/IRoadmap';
...
export default Vue.defineComponent({
  ...
  async mounted() {
    this.roadmap = await Data.fetchRoadmap('ChromeAlive');
  }
});
</script>
