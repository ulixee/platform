...
const linkGroups = require(`${__dirname}/../../../hero/docs/main/links.yaml`);

const links = generateLinks(linkGroups, 'HeroDocs');
...
export default class HeroDoc extends Vue {
  ...
  public rootPath = '/docs/hero';
  public navTitle = 'Hero'
}
</script>
