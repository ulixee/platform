...
import { z } from 'zod';
export declare const DomainSchema: z.ZodTuple<[z.ZodEffects<z.ZodEffects<z.ZodType<Buffer, z.ZodTypeDef, Buffer>, Buffer, Buffer>, Buffer, unknown>, z.ZodString], null>;
export declare const BlockVoteSchema: z.ZodObject<{
    ...
    blockRewardsAccountId: z.ZodString;
}, "strip", z.ZodTypeAny, {
    accountId: string;
    signature: Buffer;
    blockHash: Buffer;
...
export declare const NotarizationSchema: z.ZodObject<{
    ...
    domains: z.ZodArray<z.ZodTuple<[z.ZodEffects<z.ZodEffects<z.ZodType<Buffer, z.ZodTypeDef, Buffer>, Buffer, Buffer>, Buffer, unknown>, z.ZodString], null>, "many">;
}, "strip", z.ZodTypeAny, {
    balanceChanges: {
        balance: bigint;
        accountId: string;
