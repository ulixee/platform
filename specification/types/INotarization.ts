...
export const DataDomainSchema = z.tuple([
...
export const BlockVoteSchema = z.object({
  ...
  dataDomainHash: hashValidation.describe('The data domain hash used for this vote'),
  dataDomainAccount: addressValidation.describe(
...
export const NotarizationSchema = z.object({
  ...
  dataDomains: DataDomainSchema.array().max(100),
});
