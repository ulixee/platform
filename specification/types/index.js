...
exports.bufferPreprocess = exports.microgonsValidation = exports.milligonsValidation = exports.multiSignatureValidation = exports.hashValidation = exports.identitySignatureValidation = exports.identityValidation = exports.addressValidation = void 0;
...
exports.milligonsValidation = zod_1.z.preprocess(x => {
    if (typeof x === 'string') {
        if (x.endsWith('n'))
            x = x.slice(0, -1);
        return BigInt(x);
...
exports.microgonsValidation = zod_1.z.number().nonnegative();
