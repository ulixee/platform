...
export declare const ArgonPaymentProcessorApiSchema: {
    ...
    'ArgonPaymentProcessor.debit': {
        args: z.ZodObject<{
            datastoreId: z.ZodString;
            queryId: z.ZodString;
            payment: z.ZodObject<z.objectUtil.extendShape<{
...
export type IArgonPaymentProcessorApiTypes = IZodSchemaToApiTypes<typeof ArgonPaymentProcessorApiSchema>;
export type IArgonPaymentProcessorApis<TContext = any> = IZodHandlers<typeof ArgonPaymentProcessorApiSchema, TContext>;
