...
exports.DatabrokerAdminApisSchema = {
    'System.overview': {
        ...
        result: zod_1.z.object({
            ...
            balancePendingChannelHoldSettlement: types_1.milligonsValidation.describe('The balance in milligons of all channelHolds pending settlement'),
        }),
    },
    'Organization.create': {
        args: zod_1.z.object({
    ...
    'Organization.get': {
        ...
        result: zod_1.z.object({
            ...
            balanceInChannelHolds: types_1.milligonsValidation.describe('The balance currently in active channelHolds'),
        }),
    },
    'Organization.list': {
        args: zod_1.z.object({}),
