...
class PrivateDesktopApiHandler extends eventUtils_1.TypedEventEmitter {
    ...
    async saveCredit(arg) {
        const credit = await CreditReserver_1.default.storeCreditFromUrl(arg.credit.datastoreUrl, arg.credit.microgons, await this.apiManager.accountManager.getDatastoreHostLookup());
