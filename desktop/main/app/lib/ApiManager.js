...
class ApiManager extends eventUtils_1.TypedEventEmitter {
    ...
    async start() {
        ...
        this.paymentService = new LocalPaymentService_1.default();
    ...
    async getWallet() {
        ...
        const formattedBalance = ArgonUtils_1.default.format(localchainBalance + creditMilligons, 'milligons', 'argons');
        return {
