...
export declare type IHttpHandleFn = (req: Http.IncomingMessage, res: Http.ServerResponse, params: string[]) => Promise<boolean | void> | void;
export declare type IWsHandleFn = (ws: WebSocket, request: Http.IncomingMessage, params: string[]) => void;
export default class RoutableServer {
    ...
    constructor(isReadyToServe: Promise<void>, hostname?: string, addRouters?: boolean);
