import { ArgonClient, KeyringPair } from '@argonprotocol/mainchain';
...
export declare function registerZoneRecord(client: ArgonClient, domainHash: Uint8Array, owner: KeyringPair, paymentAccount: Uint8Array, notaryId: number, versions: Record<string, {
    datastoreId: string;
    host: string;
}>): Promise<void>;
